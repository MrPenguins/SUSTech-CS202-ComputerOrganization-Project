...
#
# Generated by export_simulation on Fri May 21 18:19:39 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './uart_bmpg_1.sh' script.

./uart_bmpg_1.sh -reset_run
...
./uart_bmpg_1.sh -noclean_files

For more information on the script, please type './uart_bmpg_1.sh -help'.
