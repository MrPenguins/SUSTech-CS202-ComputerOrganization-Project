...
#
# Generated by export_simulation on Fri May 21 17:58:37 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './program_rom.sh' script.

./program_rom.sh -reset_run
...
./program_rom.sh -noclean_files

For more information on the script, please type './program_rom.sh -help'.
