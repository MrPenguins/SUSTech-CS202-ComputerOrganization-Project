...
HD_PWD='G:/Spring 2021/orgnization/proj/SUSTech-CS202-ComputerOrganization-Project/project_uart_update/project_uart_update.runs/uart_bmpg_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_bmpg_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_bmpg_1.tcl
