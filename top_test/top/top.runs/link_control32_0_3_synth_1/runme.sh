...
HD_PWD='G:/Spring 2021/orgnization/proj/SUSTech-CS202-ComputerOrganization-Project/top_test/top/top.runs/link_control32_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log link_control32_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source link_control32_0_3.tcl
