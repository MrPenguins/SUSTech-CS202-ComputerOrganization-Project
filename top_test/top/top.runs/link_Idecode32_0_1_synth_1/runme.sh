...
HD_PWD='G:/Spring 2021/orgnization/proj/SUSTech-CS202-ComputerOrganization-Project/top_test/top/top.runs/link_Idecode32_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log link_Idecode32_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source link_Idecode32_0_1.tcl
