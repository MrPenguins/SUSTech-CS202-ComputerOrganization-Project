...
HD_PWD='G:/Spring 2021/orgnization/proj/SUSTech-CS202-ComputerOrganization-Project/top_test/top/top.runs/link_MemOrIO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log link_MemOrIO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source link_MemOrIO_0_0.tcl
