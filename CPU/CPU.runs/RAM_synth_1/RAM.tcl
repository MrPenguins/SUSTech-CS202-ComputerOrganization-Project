...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir D:/DigitalDesign/CPU/CPU.runs/RAM_synth_1 -new_name RAM -ip [get_ips RAM]]
...
if { [catch {
  file copy -force D:/DigitalDesign/CPU/CPU.runs/RAM_synth_1/RAM.dcp d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force D:/DigitalDesign/CPU/CPU.runs/RAM_synth_1/RAM_stub.v d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/DigitalDesign/CPU/CPU.runs/RAM_synth_1/RAM_stub.vhdl d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/DigitalDesign/CPU/CPU.runs/RAM_synth_1/RAM_sim_netlist.v d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force D:/DigitalDesign/CPU/CPU.runs/RAM_synth_1/RAM_sim_netlist.vhdl d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir D:/DigitalDesign/CPU/CPU.ip_user_files/ip/RAM]} {
  catch { 
    file copy -force d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_stub.v D:/DigitalDesign/CPU/CPU.ip_user_files/ip/RAM
  }
}

if {[file isdir D:/DigitalDesign/CPU/CPU.ip_user_files/ip/RAM]} {
  catch { 
    file copy -force d:/DigitalDesign/CPU/CPU.srcs/sources_1/ip/RAM/RAM_stub.vhdl D:/DigitalDesign/CPU/CPU.ip_user_files/ip/RAM
  }
}
